...
print("  d - Simular Deuteranopia (daltonismo verde)")
print("  p - Simular Protanopia (daltonismo rojo)")
print("  b - Simular Baja Iluminacion")
print("  t - Aumentar Temperatura (calido)")
print("  f - Bajar Temperatura (frio)")
