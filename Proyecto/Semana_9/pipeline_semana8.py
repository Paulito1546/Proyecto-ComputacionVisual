...
def compute_all_angles_from_keypoints(keypoints):
    ...
    try:
        ...
        angles['muñeca_izquierda'] = calc_angle(kp[13], kp[15], kp[19] if len(kp) > 19 else kp[15])
        angles['muñeca_derecha'] = calc_angle(kp[14], kp[16], kp[20] if len(kp) > 20 else kp[16])
        ...
        for name in ['rodilla_izquierda', 'rodilla_derecha', 'tobillo_izquierdo', 'tobillo_derecho',
                     ...
                     'muñeca_izquierda', 'muñeca_derecha', 'hombro_izquierdo', 'hombro_derecho']:
            ...
            if results.pose_landmarks:
                ...
                if frame_idx % analyze_every == 0 and len(angle_tracker.to_dataframe()) >= 2:
                    ...
                    for a in frame_alerts:
                        ...
                        elif nombre == 'muñeca': current_alert_joints.update([15, 16])
